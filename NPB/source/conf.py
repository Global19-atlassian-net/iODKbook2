...
project = u'Nonlinear processes in Biology'
copyright = u'2016, J.Ł. & M.K.'
...
html_title = u'Nonlinear processes in Biology'
...
latex_documents = [('index', 'NBP.tex', 
u'Nonlinear processes in Biology', u'J.Ł. \& M.K.', 'manual')]
