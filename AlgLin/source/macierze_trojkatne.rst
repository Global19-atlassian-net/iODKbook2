...
1. :math:`\ ` Suma dwóch dolnych macierzy trójkątnych 
   jest dolną macierzą trójkątną.
2. :math:`\ ` Pomnożenie dolnej macierzy trójkątnej przez liczbę 
   daje dolną macierz trójkątną.
3. :math:`\ ` Iloczyn dwóch dolnych macierzy trójkątnych 
   jest dolną macierzą trójkątną.
4. :math:`\ ` Odwrotność odwracalnej dolnej macierzy trójkątnej 
   jest dolną macierzą trójkątną.
